...
export function Expenses() {
  ...
  const { data: expenses, isLoading } = useListExpenses({ category: categoryFilter || undefined });
  ...
  const totalExpenses = expenses?.reduce((acc, exp) => acc + exp.amountCents, 0) || 0;

  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-foreground">Shop Expenses</h1>
